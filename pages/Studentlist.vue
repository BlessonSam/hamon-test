<template>
  <q-page>
    <q-card  class="q-mx-auto q-mt-xl justify-center items-center content-center" style="max-width:600px; border-radius:20px">
      <div class="full-width justify-center row"><h5 class="text-bold">Student List</h5></div>
